			...
			<div class="bbsCreated_bottomLine">
				<dl>
					...
					<dd>
						...
						%>
							<input type="text" name="subject" size="64" maxlength="100" 
							class="boxTF" value="<%=dto.getSubject() %>" disabled="disabled">
						<%
						}
						%>
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					...
					<dd>
						...
						%>
							<input type="text" name="name" size="35" maxlength="20" 
							class="boxTF" value="<%=dto.getName() %>" disabled="disabled">
						<%
						}
						%>
					</dd>	
				</dl>
			</div> <!-- end bbsCreated_bottomLine -->
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					...
					<dd>
						...
						%>	
							<input type="email" name="email" size="35" maxlength="50" 
							class="boxTF" value="<%=emailStr%>" disabled="disabled">
						<%
						}
						%>
					</dd>
				</dl>
			</div><!-- closed .bbsCreated_bottomLine -->
