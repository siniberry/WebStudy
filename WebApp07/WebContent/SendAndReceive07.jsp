...
<%
	...
	int nowMonth = cal.get(Calendar.MONTH)+1;			// 04
	...
	for (int year=(selectYear-10); year<=(selectYear+10) ; year++)	// 2012 ~ 2032
	{
		...
		// 상황1. 페이지 최초 요청 일  때  → sYear 는 null / 현재 년도와 옵션이 같을 때 → selected(○)
	...
	{
		// 상황1. 페이지 최초 요청 일  때  → sMonth 는 null / 현재 월과 옵션이 같을 때 → selected(○)
...
<style type="text/css">
	...
	td.nowSun {background-color: #fddde8; font-weight: bold; color: red;}
</style>
